...
export function Revolution(){
    return(
        <div className="revolution">
            <p className="join">Join our travel revolution</p>
            <div className="text">
            <p>Sign up to stay in the know - hot new travel spots,
                <br/>
...
export function OurDestination(){
    return(
        <div className="ourdestination">
            ...
            <button>Our destinations <img src={angleRight} alt="" /></button>
        </div>
    )
}