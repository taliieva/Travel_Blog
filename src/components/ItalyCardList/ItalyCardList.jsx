...
import "../../components/ItalyCardList/ItalyCardList.css";
export default function ItalyCardList(){
    return(
        <div className="italyCardListContainer">
            <h2>Available trips</h2>
            <div className="italyCardListItems">
                <CardItem photoUrl={italy1} trip="ITALY TRIP" name="Roma"
            days="34 available trip plans" from="Starts from" price="$199.00" showBookMark={false}/>
                <CardItem photoUrl={italy2} trip="PORTUGAL TRIP" name="Foodie Puglia"
            days="54 available trip plans" from="Starts from" price="$250.00" showBookMark={false}/>
                <CardItem photoUrl={italy3} trip="TURKEY TRIP" name="Foodie Puglia"
            days="19 available trip plans" from="Starts from" price="$400.00" showBookMark={false}/>
                <CardItem photoUrl={italy4} trip="ICELAND TRIP" name="Foodie Puglia"
            days="105 available trip plans" from="Starts from" price="$299.00" showBookMark={false}/>
                <CardItem photoUrl={italy5} trip="COSTA RICA TRIP" name="Foodie Puglia"
            days="23 available trip plans" from="Starts from" price="$250.00" showBookMark={false}/>
                <CardItem photoUrl={italy6} trip="ARGENTINA TRIP" name="Foodie Puglia"
