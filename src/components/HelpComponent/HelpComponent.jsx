  ...
  return (
    <div className="infoContainer">
      ...
      <div className="infoContainerItem">
        ...
        />
        <HelpCardItem frameUrl={info2} header="Things to Know"
        ...
        <HelpCardItem frameUrl={info3} header="Transportation" text="Your guide to traveling independently across Italy, from the Alps to the islands."/>
        <HelpCardItem frameUrl={info4} header="Visa Requirements" text="Italy is one of the most visited countries in Europe and its many attractions are hard to resist. Find out if you need a visa before you go."/>
        <HelpCardItem frameUrl={info5} header="Money and Costs" text="These top budget tips can help you save money while exploring Italy."/>
        <HelpCardItem frameUrl={info6} header="Traveling with Kids" text="Experience the best of Italy as a family with this guide to the top things to do there with kids."/>
      </div>
    </div>
  );
}
